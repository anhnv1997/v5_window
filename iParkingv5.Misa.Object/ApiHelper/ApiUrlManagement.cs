...
namespace Misa.Object
{
    public static class ApiUrlManagement
    {
        ...
        public static string ticketTemplateName = string.Empty;
        public static int vat_rate = 0;
        public static string token = string.Empty;
        public static TicketTemplateData? ticketTemplateData;
        ...
        //Mẫu phiếu/vé
        public static string GetTicketUrl => $"{baseUrl}/code/invoicepublishing/tickettemplates?invyear={DateTime.Now.Year}";
        ...
        {
            if (IsInvoiceWithCode)
                return $"{baseUrl}/code/itg/invoicepublished/invoicestatus?downloadDataType=" + GetDownloadTypeStr(fileDownloadType);
            return $"{baseUrl}/itg/invoicepublished/invoicestatus?downloadDataType=" + GetDownloadTypeStr(fileDownloadType);
        }
