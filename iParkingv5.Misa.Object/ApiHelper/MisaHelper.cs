    ...
    public class MisaHelper
    {
        ...
        public static Company GetCompanyInfoResult(string token)
        {
            try
            {
                ...
                string companyData = BaseApiHelper.GeneralJsonAPI(apiUrl, null, headerValues, requiredParams, timeOut, ref error, Method.Get);
        ...
        public static ListInvoiceTemplateResult GetInvoiceTemplate(string token, bool IsInvoiceWithCode, string companyCode, int year)
        {
            try
            {
                ...
                string invoiceTemplateData = BaseApiHelper.GeneralJsonAPI(apiUrl, null, headerValues, requiredParams, timeOut, ref error, Method.Get);
        ...
        public static ListInvoiceStatusResult GetInvoiceStatus(List<string> lsttransactionID, string _taxCode, string _token)
        {
            try
            {
                ...
                string serviceResultData = BaseApiHelper.GeneralJsonAPI(apiUrl, lsttransactionID, headerValues, requiredParams, timeOut, ref error, Method.Post);
        ...
        public static string GetLinkInvoiceView(string _token)
        {
            try
            {
                ...
                string serviceResultData = BaseApiHelper.GeneralJsonAPI(apiUrl, null, headerValues, requiredParams, timeOut, ref error, Method.Get);
                if (string.IsNullOrEmpty(serviceResultData))
                {
                    return "";
                }
        ...
        public static SendInvoiceEmailResult SendInvoice(string _token, string _taxCode, SendEmailParameter sendData)
        {
            try
            {
                ...
                string serviceResultData = BaseApiHelper.GeneralJsonAPI(apiUrl, sendData, headerValues, requiredParams, timeOut, ref error, Method.Post);
                if (string.IsNullOrEmpty(serviceResultData))
                {
                    return null;
                }
        ...
        public static bool CancelInvoice(string _token, string _taxCode, CancelInvoiceParamter paramter)
        {
            try
            {
                ...
                string serviceResultData = BaseApiHelper.GeneralJsonAPI(apiUrl, paramter, headerValues, requiredParams, timeOut, ref error, Method.Post);
                if (string.IsNullOrEmpty(serviceResultData))
                {
                    return false;
                }
        ...
        public static ListCreateInvoiceDataResult CreateInvoiceData(List<OriginalInvoiceData> originalInvoiceDatas, string _taxCode, string _token)
        {
            try
            {
                ...
                string serviceResultData = BaseApiHelper.GeneralJsonAPI(apiUrl, originalInvoiceDatas, headerValues, requiredParams, timeOut, ref error, Method.Post);
        ...
        public static ListPublishInvoiceResult PublishInvoiceToMisa(string _token, string _taxCode, List<PublishInvoiceData> publishInvoiceDatas)
        {
            try
            {
                ...
                string response = BaseApiHelper.GeneralJsonAPI(apiUrl, publishInvoiceDatas, headerValues, requiredParams, timeOut, ref error, Method.Post);
        ...
        public static ListPublishInvoiceResult PublishInvoiceHSMToMisa(string _token, string _taxCode, List<OriginalInvoiceDataHSM> publishInvoiceDatas, ref string response)
        {
            try
            {
                ...
                response = BaseApiHelper.GeneralJsonAPI(apiUrl, publishData, headerValues, requiredParams, timeOut, ref error, Method.Post);
