...
namespace iParkingv5_window.Usercontrols.BuildControls
{
    public partial class ucNotify : UserControl
    {
            ...
            set
            {
                ...
                switch (emNotiType)
                {
                    case EmNotiType.Information:
                        lblMessageType.Text = TextManagement.GetDisplayStr(TextManagement.EmTextDisplay.NOTIFY_INFORMATION, frmMain.language);
                        picNotiType.Image = Properties.Resources.noti_ok_64;
                        break;
                    case EmNotiType.Error:
                        lblMessageType.Text = TextManagement.GetDisplayStr(TextManagement.EmTextDisplay.NOTIFY_ERROR, frmMain.language);
                        picNotiType.Image = Properties.Resources.noti_error_64;
                        break;
                    case EmNotiType.Warning:
                        lblMessageType.Text = TextManagement.GetDisplayStr(TextManagement.EmTextDisplay.NOTIFY_WARNING, frmMain.language);
                        picNotiType.Image = Properties.Resources.noti_warning_64;
                        break;
                    case EmNotiType.Question:
                        lblMessageType.Text = TextManagement.GetDisplayStr(TextManagement.EmTextDisplay.NOTIFY_QUESTION, frmMain.language);
        ...
        private void UcNotify_Load(object? sender, EventArgs e)
        {
            ...
            btnCancel.Location = new Point(this.Width - btnCancel.Width - StaticPool.baseSize * 2,
                                           this.Height - btnCancel.Height - StaticPool.baseSize * 2);
            btnConfirm.Location = new Point(btnCancel.Location.X - btnConfirm.Width - StaticPool.baseSize,
        ...
        public void Show(EmNotiType emNotiType, string message, DialogResult preferResult = DialogResult.OK)
        {
            ...
            btnConfirm.Text = TextManagement.GetDisplayStr(TextManagement.EmTextDisplay.RESULT_CONFIRM, frmMain.language);
            btnCancel.Text = TextManagement.GetDisplayStr(TextManagement.EmTextDisplay.RESULT_CANCEL, frmMain.language);
