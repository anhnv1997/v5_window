...
namespace iParkingv5.Controller.Dahua
{
    public class DahuaAccessControl : IController
    {
        ...
        //}
        public Bdk ControllerInfo { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        ...
        public Task<string> GetComkeyAsync()
        {
            throw new NotImplementedException();
        }
        ...
        public Task<string> GetDefaultGatewayAsync()
        {
            throw new NotImplementedException();
        }
        ...
        public Task<string> GetMacAsync()
        {
            throw new NotImplementedException();
        }
        ...
        public Task<bool> OpenDoor(int timeInMilisecond, int relayIndex)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<bool> ResetDefault()
        {
            throw new NotImplementedException();
        }

        public Task<bool> RestartDevice()
        {
            throw new NotImplementedException();
        }

        public Task<bool> SetComKeyAsync(string comKey)
        {
            throw new NotImplementedException();
        }

        public Task<bool> SetDateTime(DateTime time)
        {
            throw new NotImplementedException();
        }

        public Task<bool> SetMacAsync(string macAddr)
        {
            throw new NotImplementedException();
        }

        public Task<bool> SetNetWorkInforAsync(string ip, string subnetMask, string defaultGateway, string macAddr)
        {
            throw new NotImplementedException();
        }

        public Task<bool> SyncDateTime()
        {
            throw new NotImplementedException();
        }
